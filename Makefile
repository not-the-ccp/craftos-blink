.PHONY: all check check-craftos-pc check-differential check-guest-coverage check-guest-syscalls check-upstream compatibility guest-root package bootstrap craftos-pc clean
